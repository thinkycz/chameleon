...
class CreateOrdersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->unsignedInteger('shipping_information_id')->nullable();
            $table->unsignedInteger('billing_information_id')->nullable();
            ...
            $table->foreign('shipping_information_id')->references('id')->on('shipping_informations')->onDelete('set null');
            $table->foreign('billing_information_id')->references('id')->on('billing_informations')->onDelete('set null');
