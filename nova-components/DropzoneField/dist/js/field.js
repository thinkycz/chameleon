...
Nova.booting(function (Vue, router) {
    Vue.component('detail-dropzone-field', __webpack_require__(8));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ImageDropzone__ = __webpack_require__(10);
...
var route = '/ajax/products/images';
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        var resource = this.field.value.resource.id;
...
var update = __webpack_require__(13)("1f210b66", content, false, {});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue2_dropzone__ = __webpack_require__(16);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        this.prepopulate.forEach(function (image) {
            var file = {
                id: image.id,
            ...
            _this.$refs[_this.elementId].manuallyAddFile(file, Nova.config.baseURL + image.url);
        });
    }
});
