<router-link tag="h3" :to="{name: 'jetsoft-shopconnector'}" class="cursor-pointer flex items-center font-normal dim text-white mb-6 text-base no-underline">
    ...
    <span class="sidebar-label">Shopconnector</span>
</router-link>
