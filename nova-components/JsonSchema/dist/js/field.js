...
var update = __webpack_require__(10)("9f77718c", content, false, {});
...
// module
exports.push([module.i, "\n.button-file-upload[data-v-c023248a] {\n  display: block;\n  overflow: hidden;\n}\n.button-file-upload input[type='file'][data-v-c023248a] {\n    left: -1000px;\n    position: fixed;\n}\n", ""]);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        fill: function fill(formData) {
            ...
            Object.keys(this.value).forEach(function (property) {
                formData.append(_this.field.attribute + '[' + property + ']', _this.value[property] || '');
            });
        },
        ...
        handleFileChange: function handleFileChange(e, key) {
            this.uploadedFiles[key] = e.currentTarget.files[0];
        },
        handleFileUpload: function handleFileUpload(key) {
            var _this2 = this;
            ...
            Nova.request().post('/nova-vendor/json-schema/upload-file', formData).then(function (_ref) {
                var data = _ref.data;

                _this2.value[key] = '' + Nova.config.baseURL + data.payload.media.url;
                _this2.uploadedFiles[key] = null;
            });
        },
    ...
    created: function created() {
        ...
        Object.keys(this.properties).forEach(function (key) {
            if (['image', 'file'].indexOf(_this3.properties[key].type) < 0) {
                return;
            }
...
var render = function() {
  ...
  return _c(
    ...
    _vm._l(_vm.properties, function(property, key) {
      return _c(
        "default-field",
        { key: key, attrs: { field: _vm.field, errors: _vm.errors } },
        [
          _c(
            "form-label",
            {
            ...
            [
              ...
              property.type === "textarea"
                ? _c("textarea", {
                    ...
                    staticClass:
                      "w-full form-control form-input form-input-bordered",
                    class: _vm.errorClasses,
                    attrs: { id: key, placeholder: this._.capitalize(key) },
                    domProps: { value: _vm.value[key] },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
              ...
              property.type === "image"
                ? _c("div", { staticClass: "flex justify-between" }, [
                    ...
                    _vm._v(" "),
                    _c("div", { staticClass: "upload-button ml-4" }, [
                      _c(
                        "label",
                        {
                          staticClass: "button-file-upload",
                          attrs: { for: "file-" + key }
                        },
                        [
                          _c(
                            "span",
                            { staticClass: "btn btn-primary rounded p-1" },
                            [
                              _c("icon", {
                          ...
                          _c("input", {
                            ...
                            on: {
                              change: function($event) {
                                _vm.handleFileChange($event, key)
                              }
                            }
                          })
                        ]
                    ...
                    _vm._v(" "),
                    _vm.uploadedFiles[key]
                      ? _c(
                          "span",
                          {
                            staticClass:
                              "ml-2 mt-2 cursor-pointer text-primary font-bold",
                            on: {
                              click: function($event) {
                                _vm.handleFileUpload(key)
                              }
                            }
                          },
                          [
