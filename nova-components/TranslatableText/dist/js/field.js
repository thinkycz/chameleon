...
var render = function() {
  ...
  return _c("span", [_vm._v(_vm._s(_vm.field.value[_vm.currentLocale]))])
}
var staticRenderFns = []
  ...
  return _c(
    ...
    [
      _c("template", { slot: "value" }, [
        _vm._v(
          "\n        " + _vm._s(_vm.field.value[_vm.currentLocale]) + "\n    "
        )
      ])
    ],
    2
          ...
          [
            _vm._l(_vm.locales, function(_, locale) {
              return _c("input", {
                ...
                staticClass:
                  "form-control form-input form-input-bordered flex-1 rounded-r-none",
            ...
            _c(
              ...
              [
                _c("dropdown-menu-translatable-text", {
                  model: {
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-f0206e0a", Component.options)
  } else {
    hotAPI.reload("data-v-f0206e0a", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var update = __webpack_require__(17)("b3d9a238", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-f0206e0a\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./DropdownMenu.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-f0206e0a\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./DropdownMenu.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getFlag: function getFlag(locale) {
    ...
    created: function created() {
        ...
        Array.from(this.locales).forEach(function (locale) {
            _this.currentValues[locale] = _this.getContent(locale);
        });
    }
});
...
var render = function() {
  ...
  return _c("div", { staticClass: "relative" }, [
    _c(
      ...
      [
        _c("img", {
          attrs: { src: _vm.getFlag(_vm.currentValue), alt: _vm.currentValue }
        })
      ]
    ),
    _vm._v(" "),
    _c(
      "div",
      {
        ...
        staticClass:
          "lang-dropdown rounded shadow-md absolute pin-t pin-r bg-white"
      },
      [
        _c(
          "ul",
            ...
            return _c(
              ...
              [
                _c(
                  ...
                  {
                    staticClass:
                      "px-4 py-2 block text-black hover:bg-50 no-underline",
                    attrs: { href: "#" }
                  },
                  [
                    _c("img", { attrs: { src: _vm.getFlag(key), alt: key } }),
