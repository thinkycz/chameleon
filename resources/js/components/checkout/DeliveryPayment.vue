<template>
    <div class="w-full">
        <div class="col-12 my-4">
            ...
            <div class="input-wrap -mx-2" v-for="deliveryMethod in deliveryMethods">
                <div class="radio">
                    <input type="radio"
                    ...
                    <label :for="`delivery_method_${deliveryMethod.id}`" class="radio-label text-sm">
        ...
        <div class="col-12 my-4">
            ...
            <div class="input-wrap -mx-2" v-for="paymentMethod in paymentMethods">
                <div class="radio">
                    <input type="radio"
                    ...
                    <label :for="`payment_method_${paymentMethod.id}`" class="radio-label text-sm">
            ...
            <div v-if="$_.isEmpty(paymentMethods)">
                <span v-if="selectedDelivery" class="text-sm font-semibold">{{ $trans('checkout.no_payment_methods_available') }}</span>
                <span v-else class="text-sm font-semibold">{{ $trans('checkout.please_select_delivery_method') }}</span>
            </div>
